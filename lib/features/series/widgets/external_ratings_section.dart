...
class ExternalRatingsSection extends StatelessWidget {
  ...
  List<Widget> _buildItems(
      ...
      items.add(
        WidgetUtils.tooltip(
          ...
          child: Row(
            ...
            children: [
              Icon(Icons.stars_rounded, size: 18, color: context.colors.star),
    ...
    for (int i = 0; i < sources.length; i++) {
      ...
      items.add(_buildRatingItem(context, entry.key, entry.value));
  ...
  Widget _buildRatingItem(BuildContext context, String key, dynamic data) {
  ...
  Widget _getFavicon(BuildContext context, String key) {
    final domain = _getDomain(key);

    if (domain.isEmpty) {
      return Icon(Icons.star_rounded, size: 16, color: context.colors.star);
    }
